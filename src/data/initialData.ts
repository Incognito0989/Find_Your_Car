...
export const INITIAL_USERS: UserAccount[] = [
  {
    ...
    username: 'admin',
    name: 'Admin',
    email: 'admin@platesnapcars.local',
    role: 'admin',
    avatar: '',
    bio: '',
    instagram: '',
